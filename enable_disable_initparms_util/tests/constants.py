...
EXPECTED_PAYLOAD = '-----BEGIN PRIVATE KEY-----\n-----END PRIVATE KEY-----'
...
START_BACKUP_EXPECTED= 'Started backup of certificate for node Sample'
START_BACKUP_LOG_MSG = "Start backup log line not found in logs"
COMPLETE_BACKUP_EXPECTED= 'Completed backup of certificate for node Sample'
