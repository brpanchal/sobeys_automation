...
INVALID_FILE = 'node_list_dev_invalid.json'
INITFILENAME = 'initparms.json'
FILEPATH = './Artifacts/'
NODE_LIST = ["node", "hostname", "os_type", 'fileagent.enable']
FILE_ERROR= "Node json data not found in the node list file"
...
DIR_NOT_FOUND = "Either path (None) or filename(None) is missing to load the configuration"
